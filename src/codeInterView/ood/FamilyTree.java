...
public class FamilyTree {
    ...
    public static void main(String[] args) {
        ...
        FamilyTree son1 = null, dad = null, son2 = null;

        dad = new FamilyTree(true, "Evan", null, null, null, null, null);
        FamilyTree mother = new FamilyTree(false, "Diana", null, null, null, null, null);
        son1 = new FamilyTree(true, "John", dad, mother, null, null, null);
        son2 = new FamilyTree(true, "Alex", dad, mother, null, null, null);
        FamilyTree spouse2 = new FamilyTree(false, "Nancy", null, null, son2, null, null);
        FamilyTree son3 = new FamilyTree(true, "Joe", dad, mother, null, null, null);
        FamilyTree spouse3 = new FamilyTree(false, "Niki", null, son3, null, null, null);
        FamilyTree son4 = new FamilyTree(true, "Adam", dad, mother, null, null, null);
        FamilyTree spouse4 = new FamilyTree(false, "Nisha", null, son4, null, null, null);
