...
public class ConnectionPool implements Runnable {
     ...
     * use before calling. Note that you are not <I>required to call this when done
     * with a ConnectionPool, since connections are guaranteed to be closed when
     * garbage collected. But this method gives more control regarding when the
